...
const HeroSection = () => (
  <section className="relative min-h-screen flex items-center overflow-hidden">
    ...
    <div className="absolute inset-0 hidden md:block">
      <picture>
        <source type="image/avif" srcSet="/capa-desktop.avif" />
        <img
    ...
    <div className="relative z-10 w-full py-32 px-6 md:px-8 lg:px-16 xl:px-24">
      <div className="max-w-[560px] text-left ml-0 mr-auto">
        ...
        <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-medium leading-[1.15] tracking-tight mb-8">
        ...
        <div className="md:hidden mb-8">
          <picture>
            <source type="image/avif" srcSet="/capa-mobile.avif" />
            <img
        ...
        <p className="font-body text-foreground-muted text-lg leading-relaxed mb-10 max-w-lg">
